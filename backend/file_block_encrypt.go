...
const FILE_ENC_BLOCK_SIZE_BYTES = 5 * 1024 * 1024 // Block size to use when creating new files

// Status of a write stream
type FileBlockEncryptWriteStream struct {
	f *os.File // File descryptor
...
// Closes the file, writting any pending data in the buffer
