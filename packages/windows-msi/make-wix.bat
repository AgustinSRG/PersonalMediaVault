...
call light Product.wixobj -spdb HeatFile.wixobj -cultures:en-us -loc en-us.wxl -b PersonalMediaVault -o PersonalMediaVault-5.3.0-x64.msi -ext WixUIExtension -ext WixUtilExtension
